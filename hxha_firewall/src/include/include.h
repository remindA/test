#ifndef _FW_INCLUDE_H
#define _FW_INCLUDE_H
#include "list.h"
#include "safe_free.h"
#include <stdio.h>
#include <stdlib.h>
...
#define LEN_CMD      512
#define LEN_PSD      128
#define LEN_IPT_TIME 256
#define LEN_TARGET   64
#define LEN_NATADDR  64
#define BLANK_SPACE  ' '     
#define PROTO_ALL    "all"
...
typedef struct{
    ...
    char    *extra;
    char *nat_ip;    //对于nat_ip格式限制:要么是单独地址，要么是地址范围
    char *nat_port;  //nat port格式与nat_ip地址格式有想用的限制,必须要是tcp或udp才有效
}policy_t;
